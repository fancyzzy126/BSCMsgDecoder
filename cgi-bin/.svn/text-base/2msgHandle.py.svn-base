    ...
    def getMsg(self, strMsg):
        ...
        if self.__msgUBuffer[0] == 'EMSD':
           ...
           # print '...', self.__msgFields
            #self._msgpid = self.__msgFields[16:17]
            #self._msgbufferptr = self.__msgFields[18:22]
            #print '....', self._msgbufferptr,self.__msgFields[18:22]
            #self._msgbufferlength = self.__msgFields[22:23]
            self.__msgFields = self.__msgFields[24:]
        return [True]
...
def test():
    ...
    emrv1 = ''
    nb11 = '412$13:23:54:499$0001048739$46 00 00 28 20 4D 9C 01 02 00 13 00 1D 01 08 00 00 00 58 4E 42 09 18 00 00 00 00 00 00 00 00 00 D3 24 01 BB 63 01 2B 2B 2B 2B 2B 2B 2B 00 00 00 00 00 00 00 00 00 00 00$07 40 1D 01 08 00 1D 01 35 03 00 00 C1 01 01 01 00 00 00 00 00 00 00 00'
    rt = md.getMsg(nb11)
    if not rt[0]:
        print 'wrong', rt[1]
    else:
